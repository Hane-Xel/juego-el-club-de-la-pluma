...
public class PlayerTwo {
	...
	public PlayerTwo(Aves personaje, Controles controles) {
	...
	public void actualizar() {
		// Procesar movimiento
		boolean[] movimientos = controles.obtenerMovimientoJugador2();
		personaje.procesarMovimiento(movimientos, VELOCIDAD_MOVIMIENTO);
		
		// Procesar acciones de combate
		boolean[] acciones = controles.obtenerAccionesJugador2();
